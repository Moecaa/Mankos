namespace GorillaLocomotion
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (IterativeCollisionSphereCast(lastHeadPosition, headDistance, headCollider.transform.position + rigidBodyMovement - lastHeadPosition, defaultPrecision, out finalPosition, false))
            {
